...
section.form-section input.error {                 
  height: 55px;
  width: 50%;
  color: red;
  margin-bottom: 20px;
    ...
    <center><img src="fm.png" alt="Fm" class="fm">
      <div class="col-md-10 col-md-offset-1">
        ...
        <form action="signup.php" method="post" id="footer-form">
          ...
          <div class>
              <div class>
                <label for="email" class="sr-only">What is your email?</label> <input type="email" name="email" class="form-control"  placeholder="Email" value="<?php echo $email; ?>" required>
              </div>
            </div>
          <div class>
              <div class>
                <label for="username" class="sr-only">What is your username?</label> <input type="username" name="username" class="form-control"  placeholder="Username" value="<?php echo $username; ?>" required>
              </div>
            </div>
            <div class>
              <div class>
                <label for="password_1" class="sr-only">What is your password?</label> <input type="password" class="form-control" name="password_1" placeholder="Password" required>
              </div>
            </div>
            <div class>
              <div class>
                <label for="password_2" class="sr-only">Retype the password</label> <input type="password" class="form-control" name="password_2"  placeholder="Confirm Password" required>
              </div>
            </div>
            <div class>
      ...
      <center><div class="small-text"><b>Already a user?</b> <a href="login.php">Log In. </a>
    </div>
  </div>
  <div class="clearfix"></div>
</section>
